...
def tsne(X=np.array([]), no_dims=2, initial_dims=50, perplexity=30.0, showProcess=False):
    """
...
if __name__ == "__main__":
    ...
    Y, P, Q = tsne(X, 2, 50, 20.0, showProcess=True)

    # show the final result
    pylab.clf()
    pylab.scatter(Y[:, 0], Y[:, 1], 20, labels)
    pylab.savefig(os.path.join('tsne_results','tsne_iter_final.png'))
    pylab.show()
